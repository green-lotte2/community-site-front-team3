...
const Register = () => {
  ...
  const [passwordButtonIcon, setPasswordButtonIcon] =
    useState("eye-light-off-icon");
  const [confirmPasswordType, setConfirmPasswordType] = useState("password");
  const [confirmPasswordButtonIcon, setConfirmPasswordButtonIcon] =
    useState("eye-light-off-icon");
  ...
  const togglePasswordVisibility = () => {
    ...
    setPasswordButtonIcon(
      passwordType === "password" ? "eye-light-on-icon" : "eye-light-off-icon"
    );
  };
  ...
  const handleBlur = (e) => {
    ...
    switch (name) {
      ...
      case "name":
        ...
        errorMessage = !namePattern.test(value)
      ...
      case "email":
        ...
        errorMessage = !emailPattern.test(value)
          ? "올바른 이메일 주소를 입력해주세요."
          : "";
        break;
      default:
