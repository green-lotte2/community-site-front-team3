                ...
                <div className="scroll-container" ref={scrollContainerRef}>
                    {articleList.map((article) => (
                        <div className="scroll-article" key={article.ano}>
                            <Card className="main-article-card" sx={{ minHeight: 100 }}>
                                <CardContent>
                                    <Typography className="main-eventList-title" variant="h6" component="h2">
                                        제목: {article.title}
                                    </Typography>
                                    <Typography className="main-eventList-article">
                                        내용: {cutContent(article.content, 20)}
                                    </Typography>
